...
public class SQLite : BaseDatabase<SqliteConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new(105, 1, "CREATE TABLE CrossRef_AniDB_TMDB_Episode ( CrossRef_AniDB_TMDB_EpisodeID INTEGER PRIMARY KEY AUTOINCREMENT, AnidbAnimeID INTEGER NOT NULL, AnidbEpisodeID INTEGER NOT NULL, TmdbShowID INTEGER NOT NULL, TmdbEpisodeID INTEGER NOT NULL, 'Index' INTEGER NOT NULL, MatchRating INTEGER NOT NULL);"),
