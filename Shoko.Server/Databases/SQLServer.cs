...
public class SQLServer : BaseDatabase<SqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new DatabaseCommand(112, 1, "CREATE TABLE CrossRef_AniDB_TMDB_Episode ( CrossRef_AniDB_TMDB_EpisodeID INT IDENTITY(1,1) NOT NULL, AnidbAnimeID INT NOT NULL, AnidbEpisodeID INT NOT NULL, TmdbShowID INT NOT NULL, TmdbEpisodeID INT NOT NULL, [Index] INT NOT NULL, MatchRating INT NOT NULL );"),
        ...
        new DatabaseCommand(112, 6, "CREATE TABLE TMDB_Title ( TMDB_TitleID INT IDENTITY(1,1) NOT NULL, ParentID INT NOT NULL, ParentType INT NOT NULL, LanguageCode NVARCHAR(5) NOT NULL, CountryCode NVARCHAR(5) NOT NULL, Value  NVARCHAR(512) NOT NULL );"),
        new DatabaseCommand(112, 7, "CREATE TABLE TMDB_Overview ( TMDB_OverviewID INT IDENTITY(1,1) NOT NULL, ParentID INT NOT NULL, ParentType INT NOT NULL, LanguageCode NVARCHAR(5) NOT NULL, CountryCode NVARCHAR(5) NOT NULL, Value NVARCHAR(MAX) NOT NULL );"),
        ...
        new DatabaseCommand(112, 13, "CREATE TABLE TMDB_Company_Entity ( TMDB_Company_EntityID INT IDENTITY(1,1) NOT NULL, TmdbCompanyID INT NOT NULL, TmdbEntityType INT NOT NULL, TmdbEntityID INT NOT NULL, [Index] INT NOT NULL, ReleasedAt DATE NULL );"),
        ...
        new DatabaseCommand(112, 15, "CREATE TABLE TMDB_Show ( TMDB_ShowID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, EnglishOverview NVARCHAR(MAX) NOT NULL, OriginalTitle NVARCHAR(512) NOT NULL, OriginalLanguageCode NVARCHAR(5) NOT NULL, IsRestricted BIT NOT NULL, Genres NVARCHAR(128) NOT NULL, ContentRatings NVARCHAR(128) NOT NULL, EpisodeCount INT NOT NULL, SeasonCount INT NOT NULL, AlternateOrderingCount INT NOT NULL, UserRating DOUBLE(3) NOT NULL, UserVotes INT NOT NULL, FirstAiredAt DATE, LastAiredAt DATE NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
        new DatabaseCommand(112, 16, "CREATE TABLE Tmdb_Show_Network ( TMDB_Show_NetworkID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbNetworkID INT NOT NULL, Ordering INT NOT NULL );"),
        new DatabaseCommand(112, 17, "CREATE TABLE TMDB_Season ( TMDB_SeasonID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbSeasonID INT NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, EnglishOverview NVARCHAR(MAX) NOT NULL, EpisodeCount INT NOT NULL, SeasonNumber INT NOT NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
        new DatabaseCommand(112, 18, "CREATE TABLE TMDB_Episode ( TMDB_EpisodeID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbSeasonID INT NOT NULL, TmdbEpisodeID INT NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, EnglishOverview NVARCHAR(MAX) NOT NULL, SeasonNumber INT NOT NULL, EpisodeNumber INT NOT NULL, Runtime INT NULL, UserRating DOUBLE(3) NOT NULL, UserVotes INT NOT NULL, AiredAt DATE NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
        new DatabaseCommand(112, 19, "CREATE TABLE TMDB_Episode_Cast ( TMDB_Episode_CastID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbSeasonID INT NOT NULL, TmdbEpisodeID INT NOT NULL, TmdbPersonID INT NOT NULL, TmdbCreditID NVARCHAR(64) NOT NULL, CharacterName NVARCHAR(512) NOT NULL, IsGuestRole BIT NOT NULL, Ordering INT NOT NULL );"),
        new DatabaseCommand(112, 20, "CREATE TABLE TMDB_Episode_Crew ( TMDB_Episode_CrewID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbSeasonID INT NOT NULL, TmdbEpisodeID INT NOT NULL, TmdbPersonID INT NOT NULL, TmdbCreditID NVARCHAR(64) NOT NULL, Job NVARCHAR(512) NOT NULL, Department NVARCHAR(512) NOT NULL );"),
        new DatabaseCommand(112, 21, "CREATE TABLE TMDB_AlternateOrdering ( TMDB_AlternateOrderingID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbNetworkID INT NULL, TmdbEpisodeGroupID NVARCHAR(64) NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, EnglishOverview NVARCHAR(MAX) NOT NULL, EpisodeCount INT NOT NULL, SeasonCount INT NOT NULL );"),
        new DatabaseCommand(112, 22, "CREATE TABLE TMDB_AlternateOrdering_Season ( TMDB_AlternateOrdering_SeasonID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbEpisodeGroupID NVARCHAR(64) NOT NULL, TmdbEpisodeGroupSeasonID NVARCHAR(64) NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, SeasonNumber INT NOT NULL, EpisodeCount INT NOT NULL, IsLocked BIT NOT NULL );"),
        new DatabaseCommand(112, 23, "CREATE TABLE TMDB_AlternateOrdering_Episode ( TMDB_AlternativeOrdering_EpisodeID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbEpisodeGroupID NVARCHAR(64) NOT NULL, TmdbEpisodeGroupSeasonID NVARCHAR(64) NOT NULL, TmdbEpisodeID INT NOT NULL, SeasonNumber INT NOT NULL, EpisodeNumber INT NOT NULL );"),
        new DatabaseCommand(112, 24, "CREATE TABLE TMDB_Collection ( TMDB_CollectionID INT IDENTITY(1,1) NOT NULL, TmdbCollectionID INT NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, EnglishOverview NVARCHAR(MAX) NOT NULL, MovieCount INT NOT NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
        new DatabaseCommand(112, 25, "CREATE TABLE TMDB_Collection_Movie ( TMDB_Collection_MovieID INT IDENTITY(1,1) NOT NULL, TmdbCollectionID INT NOT NULL, TmdbMovieID INT NOT NULL, Ordering INT NOT NULL );"),
        new DatabaseCommand(112, 26, "INSERT INTO CrossRef_AniDB_TMDB_Movie ( AnidbAnimeID, TmdbMovieID, Source ) SELECT AnimeID, CAST ( CrossRefID AS INT ), CrossRefSource FROM CrossRef_AniDB_Other WHERE CrossRefType = 1;"),
        new DatabaseCommand(112, 27, "DROP TABLE CrossRef_AniDB_Other;"),
        new DatabaseCommand(112, 28, "DROP TABLE MovieDB_Fanart;"),
        new DatabaseCommand(112, 29, "DROP TABLE MovieDB_Movie;"),
        new DatabaseCommand(112, 30, "DROP TABLE MovieDB_Poster;"),
        new DatabaseCommand(112, 31, "DROP TABLE AniDB_Anime_DefaultImage;"),
        new DatabaseCommand(112, 32, DatabaseFixes.CleanupAfterAddingTMDB),
    };
