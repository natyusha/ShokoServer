...
public class SQLServer : BaseDatabase<SqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new DatabaseCommand(112, 21, "CREATE TABLE TMDB_AlternateOrdering ( TMDB_AlternateOrderingID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbNetworkID INT NULL, TmdbEpisodeGroupCollectionID NVARCHAR(64) NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, EnglishOverview NVARCHAR(MAX) NOT NULL, EpisodeCount INT NOT NULL, SeasonCount INT NOT NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
        new DatabaseCommand(112, 22, "CREATE TABLE TMDB_AlternateOrdering_Season ( TMDB_AlternateOrdering_SeasonID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbEpisodeGroupCollectionID NVARCHAR(64) NOT NULL, TmdbEpisodeGroupID NVARCHAR(64) NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, SeasonNumber INT NOT NULL, EpisodeCount INT NOT NULL, IsLocked BIT NOT NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
        new DatabaseCommand(112, 23, "CREATE TABLE TMDB_AlternateOrdering_Episode ( TMDB_AlternativeOrdering_EpisodeID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbEpisodeGroupCollectionID NVARCHAR(64) NOT NULL, TmdbEpisodeGroupID NVARCHAR(64) NOT NULL, TmdbEpisodeID INT NOT NULL, SeasonNumber INT NOT NULL, EpisodeNumber INT NOT NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
