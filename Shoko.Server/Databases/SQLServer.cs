...
public class SQLServer : BaseDatabase<SqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new DatabaseCommand(112, 4, "CREATE TABLE TMDB_Image ( TMDB_ImageID INT IDENTITY(1,1) NOT NULL, TmdbMovieID INT NULL, TmdbEpisodeID INT NULL, TmdbSeasonID INT NULL, TmdbShowID INT NULL, TmdbCollectionID INT NULL, ForeignType INT NOT NULL, ImageType INT NOT NULL, IsEnabled INT NOT NULL, AspectRatio DOUBLE(3) NOT NULL, Width INT NOT NULL, Height INT NOT NULL, Language VARCHAR(64) NOT NULL, RemoteFileName VARCHAR(128) NOT NULL, UserRating DOUBLE(3) NOT NULL, UserVotes INT NOT NULL );"),
