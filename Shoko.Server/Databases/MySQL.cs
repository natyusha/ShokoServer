...
public class MySQL : BaseDatabase<MySqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new(119, 18, "CREATE TABLE `TMDB_Season` ( `TMDB_SeasonID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbSeasonID` INT NOT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `EnglishOverview` TEXT CHARACTER SET UTF8 NOT NULL, `EpisodeCount` INT NOT NULL, `SeasonNumber` INT NOT NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`TMDB_SeasonID`) );"),
