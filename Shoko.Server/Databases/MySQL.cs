...
public class MySQL : BaseDatabase<MySqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new(119, 4, "CREATE TABLE `TMDB_Image` ( `TMDB_ImageID` INT NOT NULL AUTO_INCREMENT, `TmdbMovieID` INT NULL, `TmdbEpisodeID` INT NULL, `TmdbSeasonID` INT NULL, `TmdbShowID` INT NULL, `TmdbCollectionID` INT NULL, `ForeignType` INT NOT NULL, `ImageType` INT NOT NULL, `IsEnabled` INT NOT NULL, `AspectRatio` DOUBLE(3) NOT NULL, `Width` INT NOT NULL, `Height` INT NOT NULL, `Language` NVARCHAR(64) NOT NULL, `RemoteFileName` NVARCHAR(128) NOT NULL, UserRating DOUBLE(3) NOT NULL, UserVotes INT NOT NULL, PRIMARY KEY (`TMDB_ImageID`) );"),
