...
public class MySQL : BaseDatabase<MySqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new(119, 6, "CREATE TABLE `TMDB_Title` ( `TMDB_TitleID` INT NOT NULL AUTO_INCREMENT, `ParentID` INT NOT NULL, `ParentType` INT NOT NULL, `Language` VARCHAR(32) CHARACTER SET UTF8 NOT NULL, `Value`  VARCHAR(512) CHARACTER SET UTF8 NOT NULL, PRIMARY KEY (`TMDB_TitleID`) );"),
        new(119, 7, "CREATE TABLE `TMDB_Overview` ( `TMDB_OverviewID` INT NOT NULL AUTO_INCREMENT, `ParentID` INT NOT NULL, `ParentType` INT NOT NULL, `Language` VARCHAR(32) CHARACTER SET UTF8 NOT NULL, `Value` TEXT CHARACTER SET UTF8 NOT NULL, PRIMARY KEY (`TMDB_OverviewID`) );"),
        new(119, 8, "CREATE TABLE `TMDB_Company` ( `TMDB_CompanyID` INT NOT NULL AUTO_INCREMENT, `TmdbCompanyID` INT NOT NULL, `Name` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `CountryOfOrigin` VARCHAR(3) CHARACTER SET UTF8 NOT NULL, PRIMARY KEY (`TMDB_CompanyID`) );"),
        new(119, 9, "CREATE TABLE `TMDB_Network` ( `TMDB_NetworkID` INT NOT NULL AUTO_INCREMENT, `TmdbNetworkID` INT NOT NULL, `Name` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `CountryOfOrigin` VARCHAR(3) CHARACTER SET UTF8 NOT NULL, PRIMARY KEY (`TMDB_NetworkID`) );"),
        new(119, 10, "CREATE TABLE `TMDB_Person` ( `TMDB_PersonID` INT NOT NULL AUTO_INCREMENT, `TmdbPersonID` INT NOT NULL, `EnglishName` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `EnglishBiography` TEXT CHARACTER SET UTF8 NOT NULL, `Gender` INT NOT NULL, `IsRestricted` BIT NOT NULL, `BirthDay` DATE NULL, `DeathDay` DATE NULL, `PlaceOfBirth` VARCHAR(128) CHARACTER SET UTF8 NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`TMDB_PersonID`) );"),
        new(119, 11, "CREATE TABLE `TMDB_Movie` ( `TMDB_MovieID` INT NOT NULL AUTO_INCREMENT, `TmdbMovieID` INT NOT NULL, `TmdbCollectionID` INT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `EnglishOvervie` TEXT CHARACTER SET UTF8 NOT NULL, `OriginalTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `OriginalLanguage` VARCHAR(32) CHARACTER SET UTF8 NOT NULL, `IsRestricted` BIT NOT NULL, `IsVideo` BIT NOT NULL, `Genres` VARCHAR(128) CHARACTER SET UTF8 NOT NULL, `ContentRatings` VARCHAR(128) CHARACTER SET UTF8 NOT NULL, `Runtime` INT NULL, `UserRating` DOUBLE(3) NOT NULL, `UserVotes` INT NOT NULL, `ReleasedAt` DATE NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`TMDB_MovieID`) );"),
        new(119, 12, "CREATE TABLE `TMDB_Movie_Cast` ( `TMDB_Movie_CastID` INT NOT NULL AUTO_INCREMENT, `TmdbMovieID` INT NOT NULL, `TmdbPersonID` INT NOT NULL, `TmdbCreditID` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `CharacterName` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `IsGuestRole` BIT NOT NULL, Ordering INT NOT NULL, PRIMARY KEY (`TMDB_Movie_CastID`) );"),
        new(119, 13, "CREATE TABLE `TMDB_Movie_Company` ( `TMDB_Movie_CompanyID` INT NOT NULL AUTO_INCREMENT, `TmdbMovieID` INT NOT NULL, `TmdbCompanyID` INT NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`TMDB_Movie_CompanyID`) );"),
        new(119, 14, "CREATE TABLE `TMDB_Movie_Crew` ( `TMDB_Movie_CrewID` INT NOT NULL AUTO_INCREMENT, `TmdbMovieID` INT NOT NULL, `TmdbPersonID` INT NOT NULL, `TmdbCreditID` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `Job` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `Department` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, PRIMARY KEY (`TMDB_Movie_CrewID`) );"),
        new(119, 15, "CREATE TABLE `TMDB_Show` ( `TMDB_ShowID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `EnglishOverview` TEXT CHARACTER SET UTF8 NOT NULL, `OriginalTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `OriginalLanguage` VARCHAR(32) CHARACTER SET UTF8 NOT NULL, `IsRestricted` BIT NOT NULL, `Genres` VARCHAR(128) CHARACTER SET UTF8 NOT NULL, `ContentRatings` VARCHAR(128) CHARACTER SET UTF8 NOT NULL, `EpisodeCount` INT NOT NULL, `SeasonCount` INT NOT NULL, `AlternateOrderingCount` INT NOT NULL, `UserRating` DOUBLE(3) NOT NULL, `UserVotes` INT NOT NULL, `FirstAiredAt` DATE NOT NULL, `LastAiredAt` DATE NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`TMDB_ShowID`) );"),
        new(119, 16, "CREATE TABLE `Tmdb_Show_Company` ( `TMDB_Show_CompanyID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbCompanyID` INT NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`TMDB_Show_CompanyID`) );"),
        new(119, 17, "CREATE TABLE `Tmdb_Show_Network` ( `TMDB_Show_NetworkID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbNetworkID` INT NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`TMDB_Show_NetworkID`) );"),
        new(119, 18, "CREATE TABLE `TMDB_Season` ( `TMDB_SeasonID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbSeasonID` INT NOT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `EnglishOverview` TEXT CHARACTER SET UTF8 NOT NULL, `SeasonNumber` INT NOT NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`TMDB_SeasonID`) );"),
        new(119, 19, "CREATE TABLE `TMDB_Episode` ( `TMDB_EpisodeID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbSeasonID` INT NOT NULL, `TmdbEpisodeID` INT NOT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, EnglishOverview TEXT CHARACTER SET UTF8 NOT NULL, `SeasonNumber` INT NOT NULL, `EpisodeNumber` INT NOT NULL, `Runtime` INT NULL, `UserRating` DOUBLE(3) NOT NULL, `UserVotes` INT NOT NULL, `AiredAt` DATE NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`TMDB_EpisodeID`) );"),
        new(119, 20, "CREATE TABLE `TMDB_Episode_Cast` ( `TMDB_Episode_CastID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbSeasonID` INT NOT NULL, `TmdbEpisodeID` INT NOT NULL, `TmdbPersonID` INT NOT NULL, `TmdbCreditID` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `CharacterName` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `IsGuestRole` BIT NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`TMDB_Episode_CastID`) );"),
        new(119, 21, "CREATE TABLE `TMDB_Episode_Crew` ( `TMDB_Episode_CrewID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbSeasonID` INT NOT NULL, `TmdbEpisodeID` INT NOT NULL, `TmdbPersonID` INT NOT NULL, `TmdbCreditID` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `Job` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `Department` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, PRIMARY KEY (`TMDB_Episode_CrewID`) );"),
        new(119, 22, "CREATE TABLE `TMDB_AlternateOrdering` ( `TMDB_AlternateOrderingID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbNetworkID` INT NULL, `TmdbEpisodeGroupID` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `EnglishOverview` TEXT CHARACTER SET UTF8 NOT NULL, `EpisodeCount` INT NOT NULL, `SeasonCount` INT NOT NULL, PRIMARY KEY (`TMDB_AlternateOrderingID`) );"),
        new(119, 23, "CREATE TABLE `TMDB_AlternateOrdering_Season` ( `TMDB_AlternateOrdering_SeasonID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbEpisodeGroupID` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `TmdbEpisodeGroupSeasonID` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `SeasonNumber` INT NOT NULL, `EpisodeCount` INT NOT NULL, `IsLocked` BIT NOT NULL, PRIMARY KEY (`TMDB_AlternateOrdering_SeasonID`) );"),
        new(119, 24, "CREATE TABLE `TMDB_AlternateOrdering_Episode` ( `TMDB_AlternativeOrdering_EpisodeID` INT NOT NULL AUTO_INCREMENT, `TmdbShowID` INT NOT NULL, `TmdbEpisodeGroupID` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, TmdbEpisodeGroupSeasonID VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `TmdbEpisodeID` INT NOT NULL, `SeasonNumber` INT NOT NULL, `EpisodeNumber` INT NOT NULL, PRIMARY KEY (`TMDB_AlternativeOrdering_EpisodeID`) );"),
        new(119, 25, "CREATE TABLE `TMDB_Collection` ( `TMDB_CollectionID` INT NOT NULL AUTO_INCREMENT, `TmdbCollectionID` INT NOT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `EnglishOverview` TEXT CHARACTER SET UTF8 NOT NULL, `MovieCount` INT NOT NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`TMDB_CollectionID`) );"),
        new(119, 26, "CREATE TABLE `TMDB_Collection_Movie` ( `TMDB_Collection_MovieID` INT NOT NULL AUTO_INCREMENT, `TmdbCollectionID` INT NOT NULL, `TmdbMovieID` INT NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`TMDB_Collection_MovieID`) );"),
        new(119, 27, "INSERT INTO `CrossRef_AniDB_TMDB_Movie` ( AnidbAnimeID, TmdbMovieID, Source ) SELECT AnimeID, CAST ( CrossRefID AS INT ), CrossRefSource FROM `CrossRef_AniDB_Other` WHERE CrossRefType = 1;"),
        new(119, 28, "DROP TABLE `CrossRef_AniDB_Other`;"),
        new(119, 29, "DROP TABLE `MovieDB_Fanart`;"),
        new(119, 30, "DROP TABLE `MovieDB_Movie`;"),
        new(119, 31, "DROP TABLE `MovieDB_Poster`;"),
        new(119, 32, "DROP TABLE `AniDB_Anime_DefaultImage`;"),
        new(119, 32, DatabaseFixes.CleanupAfterAddingTMDB),
    };
